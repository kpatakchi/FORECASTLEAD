...
# General directories
TRAIN_FILES=homedir+PSCRATCH_DIR2+PROJECT_NAME+"TRAIN_FILES"
DUMP_PLOT=homedir+PSCRATCH_DIR2+PROJECT_NAME+"DUMP_PLOT"
PREDICT_FILES=homedir+PSCRATCH_DIR2+PROJECT_NAME+"PREDICT_FILES"
PRODUCE_FILES=homedir+PSCRATCH_DIR2+PROJECT_NAME+"PRODUCTION_FILES"
STATS=homedir+PSCRATCH_DIR2+PROJECT_NAME+"STATS"
WEIGHTS=homedir+PSCRATCH_DIR2+PROJECT_NAME+"WEIGHTS"
