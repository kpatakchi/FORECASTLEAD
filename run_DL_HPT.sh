...
#unet_type_values=("unet-xs" "unet-s" "unet-m" "unet-l" "trans-unet")
#leadtime_values=("02" "03" "04" "05" "06" "07" "08" "09" "10")  # Adjust as needed

unet_type_values=("unet-xs" "unet-s" "unet-m" "unet-l" "trans-unet" "unet_att")
leadtime_values=("02" "03" "04" "05" "06" "07" "08" "09" "10")  # Adjust as needed

# Define weight dictionaries
declare -A unet_weights=( ["unet-xs"]=2 ["unet-s"]=2 ["unet-m"]=3 ["unet-l"]=4 ["trans-unet"]=6 ["unet_att"]=3)
declare -A leadtime_weights=( ["02"]=4 ["03"]=4 ["04"]=3 ["05"]=3 ["06"]=3 ["07"]=2 ["08"]=2 ["09"]=2 ["10"]=2 )
declare -A node_weights=( [16]=2 [14]=3 [10]=4 [8]=5 [6]=9 [4]=12 [2]=24)
...
calculate_time_limit() {
    ...
    total_seconds=$((weight_product * 930))
